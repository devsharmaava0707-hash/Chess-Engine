...
// Polyglot Random64 Zobrist Table
//
// This is the literal, verbatim 781-entry Random64 table defined by the
// Polyglot opening book format spec (Fabien Letouzey / H.G. Muller):
//   https://hgm.nubati.net/book_format.html
//
// Index layout (standard Polyglot spec):
//   [0..767]   piece-on-square keys: index = 64 * kind_of_piece + square
//              kind_of_piece: 0=BP 1=WP 2=BN 3=WN 4=BB 5=WB 6=BR 7=WR
//                             8=BQ 9=WQ 10=BK 11=WK
//              square = 8*rank + file (a1=0 ... h8=63)
...
namespace book::zobrist
{

  inline constexpr std::array<uint64_t, 781> POLYGLOT_RANDOM64 = {
